...
function Navbar() {
  ...
  const fullName = user.firstName && user.lastName ? `${user.firstName} ${user.lastName}` : "Unknown"
  ...
  return (
    <FlexBetween padding="1rem 6%" backgroundColor={alt}>
      ...
      >Devsocial</Typography>
      {isNotMobileScreens && (
        <FlexBetween borderRadius="9px" gap="3rem" padding="0.1rem 1.5rem" backgroundColor={neutralLight}>
    ...
    { isNotMobileScreens ? 
      ...
      {!isNotMobileScreens && mobileMenuToggled && (
